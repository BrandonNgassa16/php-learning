...
<body>
    ...
    <div class="content-area">
        ...
        <hr class="short-line">
        <p><span class="data-label">Monthly payment: </span><span class="focal-point">$<?php echo number_format(calculateTotalPayment($_POST["price"], $_POST['repayment-duration'], $_POST['interest-rate']), 2) ?></span></p>
        <br /><br />
    </div>
